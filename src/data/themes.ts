 ...
 *
 * Every item carries three things beyond its name: a silhouette, a line about
 * it for the player who taps its label, and a value for each of its traits. The
 * silhouette is not written in the table — it is the SVG in `assets/icons`
 * named after the theme, the category and the label, which `withIcons` works
 * out below and a test keeps honest.
 ...
 * `label, …one value per trait…, blurb`. Reading the trait values off the
 * category's own list keeps the columns and the headings from drifting apart.
 *
 * Icons are not in the table: every item's picture is the SVG named after its
 * theme, category and label, which `withIcons` fills in below.
 */
function set(
  spec: {
    id: string;
  ...
  const items = rows.map((row) => {
    if (row.length !== spec.traits.length + 2) {
      throw new Error(
        `${spec.id}: "${row[0]}" has ${row.length - 2} traits, not the expected ${spec.traits.length}`,
      );
    }
    const [label, ...rest] = row;
    return {
      label,
      // Filled in by `withIcons`, from the theme, the category and this label.
      icon: '',
    ...
    categories: [
      set(
        ...
        [
          ...
          ['Dax', 'blonde', 'brown', 'Aquarius', 'Named the coffee machine and now takes its side in disputes.'],
      ...
      set(
        ...
        [
          ...
          ['Vesta', 'asteroid', 'rocky', 'feeble', 'A lump with a mountain on it twice the height of Everest.'],
      ...
      set(
        ...
        [
          ...
          ['Lyra', 'carbon', 'mid-sized', 'solar', 'Sings on re-entry. The engineers have given up explaining it.'],
          ['Orion', 'steel', 'huge', 'nuclear', 'Built for grandeur. Turns like a cathedral.'],
          ['Pallas', 'titanium', 'huge', 'solar', 'Carries everything. Finds nothing when asked.'],
          ...
          ['Halcyon', 'titanium', 'mid-sized', 'solar', 'The calmest ship in the fleet. Nothing has gone wrong yet.'],
          ['Vesper', 'copper', 'small', 'ion', 'Only truly happy after sundown, whatever that means out here.'],
          ['Nimbus', 'carbon', 'huge', 'solar', 'Leaves a cloud behind it. Nobody has traced the source.'],
          ...
          ['Perseus', 'titanium', 'mid-sized', 'solar', 'Named for a hero. Handles like a filing cabinet.'],
      ...
      set(
        ...
        [
          ...
          ['Star Maps', 'light', 'paper', 'fragile', 'Printed, because screens have opinions about radiation.'],
          ['Water Tank', 'heavy', 'metal', 'rugged', 'Two tonnes of drinking water and one very serious lid.'],
          ['Drone Bay', 'heavy', 'metal', 'rugged', 'Eight little scouts, all of which return in a mood.'],
    ...
    categories: [
      set(
        ...
        [
          ...
          ['Dax', 'blonde', 'green', 'Gemini', 'Answers emails aloud. Nobody has found the courage to mention it.'],
      ...
      set(
        ...
        [
          ...
          ['Cortado', 'hot', 'strong', 'with milk', 'Small, serious, and gone in three sips.'],
          ['Matcha', 'hot', 'gentle', 'with milk', 'Bright green and quietly smug about the antioxidants.'],
          ['Espresso', 'hot', 'strong', 'without milk', 'A thimble of pure intent.'],
      ...
      set(
        ...
        [
          ...
          ['Patio', 'outdoors', 'roomy', 'sun', 'Charming for eleven minutes a year.'],
          ...
          ['Alcove', 'indoors', 'snug', 'shade', 'Nobody finds you here, including the staff with your order.'],
          ['Bar Stool', 'indoors', 'snug', 'sun', 'Comfortable for exactly as long as one coffee lasts.'],
          ['Booth', 'indoors', 'roomy', 'shade', 'Seats four, occupied by one and a great many bags.'],
    ...
    categories: [
      set(
        ...
        [
          ...
          ['Tamsin', 'blonde', 'blue', 'Leo', 'Rides ahead. Waits at the crossroads with a smug expression.'],
      ...
      set(
        ...
        [
          ...
          ['Gale Spear', 'wood', 'long', 'light', 'Whistles in flight, which ruins every ambush it is part of.'],
          ['Ember Blade', 'iron', 'short', 'light', 'Warm to the touch. Terrible in a scabbard, superb in a snowstorm.'],
          ['Frost Flail', 'iron', 'short', 'heavy', 'Leaves a rime on everything, including its owner.'],
          ['Thorn Whip', 'leather', 'long', 'light', 'Beautiful. Has drawn more of its owner’s blood than anyone else’s.'],
          ['Storm Mace', 'iron', 'short', 'heavy', 'Attracts lightning. Best carried by somebody else.'],
          ...
          ['Star Lance', 'silver', 'long', 'heavy', 'Fell from the sky. Nobody has asked it to leave.'],
          ['Wind Sabre', 'silver', 'long', 'light', 'Cuts on the backswing, which surprises everyone once.'],
          ['Shadow Pike', 'bone', 'long', 'heavy', 'Casts no shadow, which is considered showing off.'],
          ['Iron Halberd', 'iron', 'long', 'heavy', 'Requires two hands, a wide room and a forgiving ceiling.'],
        ],
      ),
      set(
        {
        ...
        [
          ...
          ['Cyclops', 'huge', 'caves', 'proud', 'Terrible depth perception, excellent grudge retention.'],
      ...
      set(
        ...
        [
          ...
          ['Highmere', 'mountains', 'cold', 'great', 'Thin air, thick accents, excellent cheese.'],
          ['Ironvale', 'mountains', 'dry', 'great', 'Makes half the swords in the world and complains about the noise.'],
          ...
          ['Greymarch', 'marshes', 'wet', 'great', 'Fog with a flag. The border moves when it feels like it.'],
          ['Frostgate', 'mountains', 'cold', 'small', 'Six months of winter, then a stern autumn.'],
          ...
          ['Mistvale', 'marshes', 'wet', 'small', 'Visitors get lost. Locals claim this is a feature.'],
    ...
    categories: [
      set(
        ...
        [
          ...
          ['Tobin', 'blonde', 'grey', 'Cancer', 'Sings underwater. It sounds exactly as good as it should.'],
          ...
          ['Suki', 'blonde', 'green', 'Aries', 'The only one who enjoys the safety stop.'],
      ...
      set(
        ...
        [
          ...
          ['Barracuda', 'big', 'venomous', 'smooth skin', 'All teeth and no small talk.'],
      ...
      set(
        ...
        // prettier-ignore
        [
          ['Blue Hole', 'caves', 'calm', 'dark', 'Goes down further than the guidebook is willing to print.'],
          ['Lace Wall', 'walls', 'strong', 'bright', 'Fan coral for a hundred metres. Nobody talks on the way back.'],
          ['Shipwreck', 'wreckage', 'calm', 'dark', 'A cargo of teapots, still stacked, still waiting.'],
          ...
          ['Anchor Bay', 'sand', 'calm', 'bright', 'Two centuries of lost anchors, arranged by accident.'],
    ...
    categories: [
      ...
      set(
        ...
        [
          ...
          ['Aster', 'purple', 'faint', 'many', 'A star that keeps flowering when everything else has given up.'],
      ...
      set(
        ...
        [
          ...
          ['Ivory', 'glazed clay', 'small', 'glossy', 'Shows every speck of soil and is repotted indoors, carefully.'],
          ['Copper', 'metal', 'small', 'glossy', 'Went green in a fortnight and looks better for it.'],
          ['Slate', 'stone', 'big', 'matt', 'Weighs as much as the plant and twice as much when watered.'],
          ...
          ['Charcoal', 'stone', 'small', 'matt', 'Absorbs heat all afternoon and cooks the roots by August.'],
      ...
      set(
        ...
        [
          ...
          ['Shears', 'steel', 'cutting', 'big', 'Sharpened every spring by a man who charges too much.'],
          ...
          ['Hoe', 'steel', 'digging', 'big', 'Removes weeds and, occasionally, an entire row of seedlings.'],
          ['Twine', 'jute', 'sorting', 'small', 'Ties everything. Has tied things that were never meant to be tied.'],
          ['Secateurs', 'steel', 'cutting', 'small', 'The only tool nobody is allowed to borrow.'],
          ['Kneeler', 'plastic', 'sorting', 'big', 'The single most sensible purchase on the entire allotment.'],
          ['Sieve', 'steel', 'sorting', 'big', 'Turns lumpy compost into something worth putting seeds in.'],
          ...
          ['Plant Labels', 'plastic', 'sorting', 'small', 'Written in pencil, faded by June, argued about in July.'],
        ],
      ),
      scale({
        id: 'height',
 ...
 *
 * Worked out rather than written down, so a table of items cannot drift out of
 * step with the folder of drawings — and `scripts/icons.mjs` names the files by
 * the same rule. A test checks every one of them exists.
 */
export function iconName(theme: string, category: string, label: string): string {
  const slug = label
    .toLowerCase()
    .replace(/[^a-z0-9]+/g, '-')
    .replace(/^-+|-+$/g, '');
  return `${theme}/${category}-${slug}`;
}
  ...
  for (const theme of themes) {
    ...
    for (const category of theme.categories) {
      for (const item of category.items) {
        item.icon = iconName(theme.id, category.id, item.label);
      }
    }
  }
  return themes;
