...
`npm run screenshots:ipad` walks the same twenty-five screens as
...
| | | |
|---|---|---|
| <img src="screenshots/ipad/01-start.png" width="230" alt="The front door on an iPad"><br>**1. Start** — the doors at phone size on half a page of nothing, and a panel of flat colour above them. | <img src="screenshots/ipad/02-mode.png" width="230" alt="The two ways of playing on an iPad"><br>**2. Pure or Classic** — two phrases at phone size in the top-left corner, with the rest of the page looking on. | <img src="screenshots/ipad/03-setup.png" width="230" alt="The difficulties on an iPad"><br>**3. Difficulty** — five words down the left edge, and the rest of the screen unused. |
| <img src="screenshots/ipad/04-numbers.png" width="230" alt="The numbered puzzles on an iPad"><br>**4. Numbered puzzles** — five to a page, which is what a 375-point phone holds; the tablet has room for far more and is not asked for it. | <img src="screenshots/ipad/05-daily.png" width="230" alt="The daily challenges on an iPad"><br>**5. Daily** — the same four names, the same left margin. | <img src="screenshots/ipad/06-settings.png" width="230" alt="Settings on an iPad"><br>**6. Settings** — the rows do stretch, and it does not help: *Colour* and *Blue* end up at opposite edges, and the volume slider runs the width of the page. |
| <img src="screenshots/ipad/07-briefing.png" width="230" alt="A briefing on an iPad"><br>**7. Briefing** — capped at 360 points and floating, which is the one cap that is arguably right. | <img src="screenshots/ipad/08-board.png" width="230" alt="The board on an iPad"><br>**8. Grid** — the staircase capped at 46-point squares, in the top-left corner of the canvas, with the toolbar hundreds of points away. | <img src="screenshots/ipad/09-menu.png" width="230" alt="The puzzle settings on an iPad"><br>**9. Puzzle settings** — six settings and a way to start over, in the top third of the page. |
| <img src="screenshots/ipad/10-clue.png" width="230" alt="The clue window on an iPad"><br>**10. Clue** — phone-sized in the middle of the screen. | <img src="screenshots/ipad/11-highlight.png" width="230" alt="A lit clue on an iPad"><br>**11. Highlight** — the crosshair still works; there is simply more page around it. | <img src="screenshots/ipad/12-marked.png" width="230" alt="A part-marked board on an iPad"><br>**12. Marked up** — the marks are drawn at the cell size, so they stay small with it. |
| <img src="screenshots/ipad/13-stuck.png" width="230" alt="The rewind window on an iPad"><br>**13. Marks that disagree** — the window is unchanged. | <img src="screenshots/ipad/14-item-card.png" width="230" alt="An item card on an iPad"><br>**14. Item card** — a card built for a phone, on a tablet. | <img src="screenshots/ipad/15-solved.png" width="230" alt="A finished game on an iPad"><br>**15. Solved** — the one screen the width improves: all four sets fit, so the answer table stops asking to be swiped. |
| <img src="screenshots/ipad/16-statistics.png" width="230" alt="Statistics on an iPad"><br>**16. Statistics** — the screen that survives this best: cards and rows that fill what they are given, tabs and all. | <img src="screenshots/ipad/17-achievements.png" width="230" alt="The achievement cards on an iPad"><br>**17. Achievements** — wide cards, and the one place on this page where the width is no trouble: a sentence has room to be a sentence. | <img src="screenshots/ipad/18-night.png" width="230" alt="Night colours on an iPad"><br>**18. Night** — the colours are the colours; the layout is the layout. |
| <img src="screenshots/ipad/19-catalogue.png" width="230" alt="The zoomed-out catalogue on an iPad"><br>**19. Zoomed out** — five groups where a tablet could show twenty-five. | <img src="screenshots/ipad/20-lessons.png" width="230" alt="The How to play menu on an iPad"><br>**20. How to play** — three lessons, held to 25 points to fit a phone that is not this one, at a text size this one is not set to either. | <img src="screenshots/ipad/21-clue-lessons.png" width="230" alt="The Understanding clues menu on an iPad"><br>**21. Understanding clues** — five short lines in the top-left quarter. |
| <img src="screenshots/ipad/22-lesson-briefing.png" width="230" alt="A lesson briefing on an iPad"><br>**22. A lesson opens** — the same window as a puzzle's, which is still true here. | <img src="screenshots/ipad/23-lesson-clue.png" width="230" alt="A lesson's clue window on an iPad"><br>**23. Clue** — the words a lesson runs on, at phone width. | <img src="screenshots/ipad/24-lesson-board.png" width="230" alt="A lesson board on an iPad"><br>**24. The board** — a 3 × 3 grid capped at the teaching size, adrift in the middle. |
| <img src="screenshots/ipad/25-lesson-next.png" width="230" alt="The next lesson step on an iPad"><br>**25. On to the next** — the flow works; the proportions do not. |  |  |
