...
`npm run screenshots:ipad` walks the same twenty-four screens as
...
| <img src="screenshots/ipad/16-statistics.png" width="230" alt="Statistics on an iPad"><br>**16. Statistics** — the screen that survives this best: cards and rows that fill what they are given, tabs and all. | <img src="screenshots/ipad/17-night.png" width="230" alt="Night colours on an iPad"><br>**17. Night** — the colours are the colours; the layout is the layout. | <img src="screenshots/ipad/18-catalogue.png" width="230" alt="The zoomed-out catalogue on an iPad"><br>**18. Zoomed out** — five groups where a tablet could show twenty-five. |
| <img src="screenshots/ipad/19-lessons.png" width="230" alt="The How to play menu on an iPad"><br>**19. How to play** — three lessons, held to 25 points to fit a phone that is not this one, at a text size this one is not set to either. | <img src="screenshots/ipad/20-clue-lessons.png" width="230" alt="The Understanding clues menu on an iPad"><br>**20. Understanding clues** — five short lines in the top-left quarter. | <img src="screenshots/ipad/21-lesson-briefing.png" width="230" alt="A lesson briefing on an iPad"><br>**21. A lesson opens** — the same window as a puzzle's, which is still true here. |
| <img src="screenshots/ipad/22-lesson-clue.png" width="230" alt="A lesson's clue window on an iPad"><br>**22. Clue** — the words a lesson runs on, at phone width. | <img src="screenshots/ipad/23-lesson-board.png" width="230" alt="A lesson board on an iPad"><br>**23. The board** — a 3 × 3 grid capped at the teaching size, adrift in the middle. | <img src="screenshots/ipad/24-lesson-next.png" width="230" alt="The next lesson step on an iPad"><br>**24. On to the next** — the flow works; the proportions do not. |
